...
local PremiumLibrary = {
	Flags = {},
	Theme = {
		Default = {
			TextFont = "Default", -- Default will use the various font faces used across Premium
		...
		Light = {
			TextFont = "Gotham", -- Default will use the various font faces used across Premium
...
local Premium = game:GetObjects("rbxassetid://10804731440")[1]

Premium.Enabled = false


if gethui then
	Premium.Parent = gethui()
elseif syn.protect_gui then 
	syn.protect_gui(Premium)
	Premium.Parent = CoreGui
elseif CoreGui:FindFirstChild("RobloxGui") then
	Premium.Parent = CoreGui:FindFirstChild("RobloxGui")
else
	Premium.Parent = CoreGui
end
...
if gethui then
	for _, Interface in ipairs(gethui():GetChildren()) do
		if Interface.Name == Premium.Name and Interface ~= Premium then
			Interface.Enabled = false
			Interface.Name = "Premium-Old"
		end
	end
else
...
local Main = Premium.Main
local Topbar = Main.Topbar
local Elements = Main.Elements
local LoadingFrame = Main.LoadingFrame
local TabList = Main.TabList

Premium.DisplayOrder = 100
...
local Notifications = Premium.Notifications

local SelectedTheme = PremiumLibrary.Theme.Default

function ChangeTheme(ThemeName)
	SelectedTheme = PremiumLibrary.Theme[ThemeName]
	for _, obj in ipairs(Premium:GetDescendants()) do
	...
	Premium.Main.BackgroundColor3 = SelectedTheme.Background
	Premium.Main.Topbar.BackgroundColor3 = SelectedTheme.Topbar
	Premium.Main.Topbar.CornerRepair.BackgroundColor3 = SelectedTheme.Topbar
	Premium.Main.Shadow.Image.ImageColor3 = SelectedTheme.Shadow

	Premium.Main.Topbar.ChangeSize.ImageColor3 = SelectedTheme.TextColor
	Premium.Main.Topbar.Hide.ImageColor3 = SelectedTheme.TextColor
	Premium.Main.Topbar.Theme.ImageColor3 = SelectedTheme.TextColor
...
local function LoadConfiguration(Configuration)
	...
	for FlagName, FlagValue in next, Data do
		if PremiumLibrary.Flags[FlagName] then
			spawn(function() 
				if PremiumLibrary.Flags[FlagName].Type == "ColorPicker" then
					PremiumLibrary.Flags[FlagName]:Set(UnpackColor(FlagValue))
				else
					if PremiumLibrary.Flags[FlagName].CurrentValue or PremiumLibrary.Flags[FlagName].CurrentKeybind or PremiumLibrary.Flags[FlagName].CurrentOption or PremiumLibrary.Flags[FlagName].Color ~= FlagValue then PremiumLibrary.Flags[FlagName]:Set(FlagValue) end
				end    
			end)
		else
			PremiumLibrary:Notify({Title = "Flag Error", Content = "Premium was unable to find '"..FlagName.. "'' in the current script"})
		end
	end
end
...
local function SaveConfiguration()
	...
	local Data = {}
	for i,v in pairs(PremiumLibrary.Flags) do
...
function PremiumLibrary:Notify(NotificationSettings)
	spawn(function()
		...
		if NotificationSettings.Actions then
			for _, Action in pairs(NotificationSettings.Actions) do
				...
				if SelectedTheme ~= PremiumLibrary.Theme.Default then
				...
				NewAction.MouseButton1Click:Connect(function()
					...
					if not Success then
						print("Premium | Action: "..Action.Name.." Callback Error " ..tostring(Response))
					end
		...
		Notification.Title.Text = NotificationSettings.Title or "Da Hood Premium"
		Notification.Title.TextTransparency = 1
		Notification.Title.TextColor3 = SelectedTheme.TextColor
		Notification.Description.Text = NotificationSettings.Content or "Successfully Loaded"
...
function Hide(notify: boolean?)
	Debounce = true
	if notify then
		PremiumLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping K", Duration = 7})
	end
...
function PremiumLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Premium Interface Suite"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "by Sirius"
	if Settings.LoadingTitle ~= "Premium Interface Suite" then
		LoadingFrame.Version.Text = "Da Hood Premium"
	end
	...
	pcall(function()
		...
		if not isfolder(PremiumFolder.."/".."Configuration Folders") then
	...
	if Settings.Discord then
		if not isfolder(PremiumFolder.."/Discord Invites") then
			makefolder(PremiumFolder.."/Discord Invites")
		end
		if not isfile(PremiumFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension) then
			if request then
				request({
			...
			if Settings.Discord.RememberJoins then -- We do logic this way so if the developer changes this setting, the user still won't be prompted, only new users
				writefile(PremiumFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension,"Premium RememberJoins is true for this invite, this invite will not ask you to join again")
			end
		else
	...
	if Settings.KeySystem then
		...
		if not isfolder(PremiumFolder.."/Key System") then
			makefolder(PremiumFolder.."/Key System")
		end
		...
		if Settings.KeySettings.GrabKeyFromSite then
			for i, Key in ipairs(Settings.KeySettings.Key) do
				...
				if not Success then
					print("Premium | "..Key.." Error " ..tostring(Response))
				end
			end
		end
		...
		if isfile(PremiumFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) then
			for _, MKey in ipairs(Settings.KeySettings.Key) do
				if string.find(readfile(PremiumFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension), MKey) then
					Passthrough = true
				end
			end
		end
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				...
				if KeyFound then 
					...
					if Settings.KeySettings.SaveKey then
						if writefile then
							writefile(PremiumFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension, FoundKey)
						end
						PremiumLibrary:Notify({Title = "Key System", Content = "The key for this script has been saved successfully"})
					end
				else
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					print("Premium | "..ButtonSettings.Name.." Callback Error " ..tostring(Response))
					task.wait(0.5)
					Button.Title.Text = ButtonSettings.Name
		...
		function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and ColorPickerSettings.Flag then
					PremiumLibrary.Flags[ColorPickerSettings.Flag] = ColorPickerSettings
				end
			end
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				...
				if not Success then
					...
					print("Premium | "..InputSettings.Name.." Callback Error " ..tostring(Response))
					task.wait(0.5)
					Input.Title.Text = InputSettings.Name
		...
		function Tab:CreateDropdown(DropdownSettings)
				...
				for _, Option in ipairs(DropdownSettings.Options) do
					...
					DropdownOption.Interact.MouseButton1Click:Connect(function()
						...
						if not Success then
							...
							print("Premium | "..DropdownSettings.Name.." Callback Error " ..tostring(Response))
							task.wait(0.5)
							Dropdown.Title.Text = DropdownSettings.Name
							TweenService:Create(Dropdown, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and DropdownSettings.Flag then
					PremiumLibrary.Flags[DropdownSettings.Flag] = DropdownSettings
				end
			end
		...
		function Tab:CreateKeybind(KeybindSettings)
				...
				elseif KeybindSettings.CurrentKeybind ~= nil and (input.KeyCode == Enum.KeyCode[KeybindSettings.CurrentKeybind] and not processed) then -- Test
					...
					if not KeybindSettings.HoldToInteract then
						...
						if not Success then
							...
							print("Premium | "..KeybindSettings.Name.." Callback Error " ..tostring(Response))
							task.wait(0.5)
							Keybind.Title.Text = KeybindSettings.Name
							TweenService:Create(Keybind, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and KeybindSettings.Flag then
					PremiumLibrary.Flags[KeybindSettings.Flag] = KeybindSettings
				end
			end
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			Toggle.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					print("Premium | "..ToggleSettings.Name.." Callback Error " ..tostring(Response))
					task.wait(0.5)
					Toggle.Title.Text = ToggleSettings.Name
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and ToggleSettings.Flag then
					PremiumLibrary.Flags[ToggleSettings.Flag] = ToggleSettings
				end
			end
		...
		function Tab:CreateSlider(SliderSettings)
					...
					if Dragging then
						...
						if SliderSettings.CurrentValue ~= NewValue then
							...
							if not Success then
								...
								print("Premium | "..SliderSettings.Name.." Callback Error " ..tostring(Response))
								task.wait(0.5)
								Slider.Title.Text = SliderSettings.Name
								TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and SliderSettings.Flag then
					PremiumLibrary.Flags[SliderSettings.Flag] = SliderSettings
				end
			end
...
function PremiumLibrary:SetVisibility(visibility: boolean)
	setVisibility(visibility, false)
end

function PremiumLibrary:IsVisible(): boolean
	return not Hidden
end

function PremiumLibrary:Destroy()
	Premium:Destroy()
end
...
function PremiumLibrary:LoadConfiguration()
	if CEnabled then
		pcall(function()
			if isfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension) then
				LoadConfiguration(readfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension))
				PremiumLibrary:Notify({Title = "Configuration Loaded", Content = "The configuration file for this script has been loaded from a previous session"})
			end
		end)
	end
end

task.delay(3.5, PremiumLibrary.LoadConfiguration, PremiumLibrary)
